        ...
        prototype: {
            init: function () {
                ...
                return this.lastElement = d, void 0 === d ? delete this.invalid[c.name] : (this.prepareElement(d),
                    this.currentElements = a(d), e = this.check(d) !== !1, e ? delete this.invalid[d.name] :
               ...
               $('.icon-valid').remove();//agregado por francis
                $('.valid').parent().append('<i class="icon-valid fa fa-check"></i>')//agregado por francis
