...
<div class="panel-heading">
    ...
    <li><a href="{{URL::route('index')}}">Home</a></li>
         ...
         <li><a href="{{URL::route("indicator_list_departament",[$departament->id_dpto])}}">Indicators</a></li>
         <li><a href="#">New</a></li>
     </ul>
</div>
        ...
        <div class="row">
            <fieldset class="col-md-12">
                    ...
                    <div class="form-group">
                           ...
                           <label class="col-md-3 col-lg-2 control-label" >Department <span class="text-danger"> *</span></label>
            ...
            <fieldset class="col-sm-12">
                ...
                <div class=" col-xs-6 col-md-3">
                    <a href="{{URL::route("indicator_list_departament",[$departament->id_dpto])}}" class="col-xs-12 btn btn-default">
