...
<div class=" col-xs-12 col-lg-12 col-sm-12">
    {{ Form::open(array('url' => URL::route("market_edit"),'method'=>"post",'id'=>"form_edit_market",'action'=>"validators.html",'class'=>"form-horizontal")) }}
         ...
         @if($errors->any())
                ...
                @endif
                    ...
                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12 col-md-8">
                                            <select class="form-control chosen-select" required="required" name="group_type" id="group_type">
                                                <option value="{{$market->group_type}}">{{$market->group_type}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input type="text" class="form-control" required="required"  placeholder="Store number" value="{{$market->num_market}}"   maxlength="50" id="num_market" name="num_market"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <textarea class="form-control" placeholder="Address"
                                      cols="50" rows="5" name="address" id="address" value="">{{$market->address}}</textarea>
                        </div>
            ...
            <fieldset class="col-sm-12">
                ...
                <div class=" col-xs-6 col-sm-3">
                    <a href="{{URL::route('market_list')}}" class="col-xs-12 btn btn-default">
                     <i class="fa fa fa-times fa-fw"></i>Cancel</a>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#form_edit_market").validate({
         ...
         $("#form_edit_market input,#form_edit_market textarea").keyup(function(){
                            if($("#form_edit_market").valid())
                                $('.btn-add').removeClass('disabled');
                            else
                            $('.btn-add').addClass('disabled')
                        });
        $("#form_edit_market select").change(function(){
            if($("#form_edit_market").valid())
                $('.btn-add').removeClass('disabled');
            else
            $('.btn-add').addClass('disabled')
