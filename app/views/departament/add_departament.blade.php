...
<div class="panel-heading">
     <ul class="breadcrumb">
        <li><a href="{{URL::route('index')}}">Home</a></li>
         <li><a href="{{URL::route("departament_list_market",array($market->id_market))}}">Departments</a></li>
         <li><a href="#">New</a></li>
     </ul>
</div>
...
<div class=" col-xs-12 col-lg-12 col-sm-12">
    {{ Form::open(array('url' => URL::route("departament_add"),'method'=>"post",'id'=>"form_add_departament",'action'=>"validators.html",'class'=>"form-horizontal")) }}
        ...
        <div class="row">
            ...
            <fieldset class="col-sm-12">
                ...
                <div class=" col-xs-6 col-md-3">
                    <a href="{{URL::route("departament_list_market",array($market->id_market))}}"
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#form_add_departament").validate({
          ...
          $("#form_add_departament input").keyup(function(){
                            if($("#form_add_departament").valid())
