...
<div class=" col-xs-12 col-lg-12 col-sm-12">
    {{ Form::open(array('url' => URL::route("users_add"),'method'=>"post",'id'=>"form_add_user",'action'=>"validators.html",'class'=>"form-horizontal")) }}
            ...
            @if($errors->any())
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input type="text" class="form-control" required="required"  placeholder="Name" maxlength="50" name="name" id="name"/>
                        </div>
                    </div>
					<div class="form-group col-xs-12">
                        <label class="col-md-3 col-lg-2 control-label">Surname<span class="text-danger"> *</span> </label>
                        <div class="col-sm-12 col-md-8">
                            <input type="text" class="form-control" required="required"  placeholder="Surname" name="surname" id="surname" maxlength="50"/>
                        </div>
                    </div>
					<div class="form-group col-xs-12">
				...
				<div class="form-group col-xs-12">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input type="text" class="form-control" required="required"  placeholder="Username"  name="username" id="username" maxlength="50"/>
                        </div>
                    </div>
					<div class="form-group col-xs-12">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#form_add_user input").keyup(function(){
            if($("#form_add_user").valid())
                $('.btn-add').removeClass('disabled')
            else
            $('.btn-add').addClass('disabled')
        })
        $("#form_add_user select").change(function(){
            if($("#form_add_user").valid())
                $('.btn-add').removeClass('disabled')
            else
            $('.btn-add').addClass('disabled')
